...
{
    class AeTextureManager : AeISubsystem
    {
        ...
        //RsGame gameReference;

        //public RsTextureManager(RsGame myGame)
        //{
        ...
        //    Texture2D tex = new Texture2D(RsEngine.Get().GameReference.GraphicsDevice, width, height, false, SurfaceFormat.Color);
        ...
        //    }
        //    else
        //        throw new RsException("Texture doesn't exist.");
        //}
        ...
        //    }
        //    else
        //        throw new RsException("Colletion doesn't exist.");
        //}
    }
}
